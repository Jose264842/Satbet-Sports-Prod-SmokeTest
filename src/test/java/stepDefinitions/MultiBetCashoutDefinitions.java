...
public class MultiBetCashoutDefinitions extends Helper
{
	@Given("I click on the Sports option MB")
	public void i_click_on_the_sports_option_mb() throws Throwable
	{
		try
		{
			String cname = new MultiBetCashoutDefinitions().getClass().getName();
	...
	public void i_click_on_the_game_category_mb_f_cout() throws Throwable
	{
		try 
		{
	...
	public void i_select_one_odds_mb_f_cout() throws Throwable
	{
		try 
		{
			Thread.sleep(10000);
	...
	public void i_enable_the_always_allow_odd_changes_option_mb_f_cout() throws Throwable
	{
		try 
		{
	...
	public void i_enter_the_amount_mb_f_cout() throws Throwable
	{
		try 
		{
	...
	public void i_click_on_the_place_bet_success_button_mb_f_cout() throws Throwable
	{
		try 
		{
			new WebDriverWait(driver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[text() =' Place Bet ']")));
			WebElement pb1 = driver.findElement(By.xpath("//*[text() =' Place Bet ']"));
	...
	public void click_on_cashout_mb_f_cout() throws Throwable
	{
		try 
		{
	...
	public void click_on_full_cashout_btn_mb_f_cout() throws Throwable
	{
		try 
		{
	...
	public void click_on_confirm_full_cashout_btn_mb_f_cout() throws Throwable
	{
		try 
		{
			Thread.sleep(3000);
...
//	public void observe_the_full_cashout_successful_mb_f_cout() throws Throwable
//	{
//		try 
//		{
//			Thread.sleep(10000);
...
//	}
	...
	public void i_select_one_odds_mb_p_cout() throws Throwable
	{
		try 
		{
			Thread.sleep(10000);
	...
	public void i_enable_the_always_allow_odd_changes_option_mb_p_cout() throws Throwable
	{
		try 
		{
			if(checkElement(driver, "//div[@class='checkbox1']/input"))
	...
	public void i_enter_the_amount_mb_p_cout() throws Throwable
	{
		try 
		{
			new WebDriverWait(driver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[text()='100']")));
	...
	public void i_click_on_the_place_bet_success_button_mb_p_cout() throws Throwable
	{
		try 
		{
			new WebDriverWait(driver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[text() =' Place Bet ']")));
	...
	public void click_on_cashout_mb_p_cout() throws Throwable
	{
		try 
		{
			new WebDriverWait(driver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[text()='Cash Out']")));
	...
	public void click_on_partial_cashout_btn_mb_p_cout() throws Throwable
	{
		try 
		{
		    ...
		    //((JavascriptExecutor) driver).executeScript("arguments[0].style.left = '127px';", elementToSlide);
	        // Perform the slide and hold action
	...
	public void click_on_confirm_partial_cashout_btn_mb_p_cout() throws Throwable
	{
		try 
		{
...
//	public void observe_the_partial_cashout_successful_mb_p_cout() throws Throwable
//	{
//		try 
//		{
//			Helper.clearCashout();
